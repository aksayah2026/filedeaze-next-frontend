    ...
    <div>
      ...
      <div className="flex flex-wrap gap-3 mb-4">
        <Select
          ...
          className="w-44"
        />
        <Input type="date" value={draftFilters.from} onChange={e => setDraftFilters(p => ({ ...p, from: e.target.value }))} />
        <Input type="date" value={draftFilters.to} onChange={e => setDraftFilters(p => ({ ...p, to: e.target.value }))} />
